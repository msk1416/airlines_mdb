...
--Tests
EXECUTE CHANGE_PASSENGER (902380, 'WZ877', 41155478);
EXECUTE CHANGE_PASSENGER (41155478, 'KL237', 66599);
EXECUTE CHANGE_PASSENGER (4225448, 'KL237', 47331569);
EXECUTE CHANGE_PASSENGER (66599, 'KL237', 902380);
